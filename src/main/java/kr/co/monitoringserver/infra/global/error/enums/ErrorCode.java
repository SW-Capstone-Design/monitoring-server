...
public enum ErrorCode {
    ...
    FAIL(203, HttpStatus.NON_AUTHORITATIVE_INFORMATION, "실행에 실패했습니다"),
    ...
    // Attendance
    NOT_FOUND_ATTENDANCE(404, HttpStatus.NOT_FOUND, "해당 출석 정보를 찾지 못하였습니다"),
    DUPLICATE_ATTENDANCE(400, HttpStatus.BAD_REQUEST, "해당 사용자는 이미 출석하였습니다"),
